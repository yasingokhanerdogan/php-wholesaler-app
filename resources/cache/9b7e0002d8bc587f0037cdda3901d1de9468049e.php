                            ...
                            <div class="card-body">
                                <div class="row">
                                    <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($product->getCategory->status == "1"): ?>
                                                    ...
                                                    <div class="col-sm-12">
                                                        ...
                                                        <div class="float-sm-end">
                                                            <ul class="pagination pagination-rounded mb-sm-0">
                                                                ...
                                                                <?php if($pagination["page"] != 1): ?>
                                                                    <li class="page-item">
                                                                        <a href="<?php echo e(url("backend.client.products", ["page" => "1"])); ?>"
                                                                ...
                                                                <?php for($i = $pagination["page"] - $pagination["forlimit"]; $i < $pagination["page"] + $pagination["forlimit"] + 1; $i++): ?>
                                                                    ...
                                                                    <?php if($i > 0 && $i <= $pagination["pageCount"]): ?>
                                                                        ...
                                                                        <?php else: ?>
                                                                            ...
                                                                            <li class="page-item">
                                                                                <a href="<?php echo e(url("backend.client.products", ["page" => $i])); ?>"
                                                                                   class="page-link"><?php echo e($i); ?></a>
                                                                            </li>
                                                                ...
                                                                <?php if($pagination["page"] != $pagination["pageCount"]): ?>
                                                                    ...
                                                                    <li class="page-item">
                                                                        <a href="<?php echo e(url("backend.client.products", ["page" => $pagination["pageCount"]])); ?>"
...
<?php echo $__env->make("backend.layouts.master", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/yasingok/tekstil-demo.yasingokhanerdogan.com/resources/views/backend/clientArea/products/products.blade.php ENDPATH**/ ?>