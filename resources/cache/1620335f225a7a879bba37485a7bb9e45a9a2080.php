...
<?php $__env->startSection("title", "Kullanıcı Ekle | $settings->title"); ?>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div id="createAdmin">
                                <form method="POST" action="<?php echo e(url("backend.admin.users.createAdmin")); ?>"
                                      id="createAdminForm">
                            ...
                            <div id="createClient">
                                <form method="POST" action="<?php echo e(url("backend.admin.users.createClient")); ?>"
                                      id="createClientForm">
                                    <h3 class="mb-4 card-title">Kullanıcı Giriş Bilgileri</h3>
                                    <div class="row">
                                        <div class="mb-3 row">
...
<?php echo $__env->make("backend.layouts.master", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/httpdaff/tekstil-demo.yasingokhanerdogan.com/resources/views/backend/adminArea/users/add.blade.php ENDPATH**/ ?>