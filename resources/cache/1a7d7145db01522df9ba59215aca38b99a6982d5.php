...
<?php $__env->startSection("title", "Ürün Ekle | $settings->title"); ?>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div id="create_product_area">
                                <form method="POST" action="<?php echo e(url("backend.admin.product.create")); ?>" id="createProductForm" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="mb-3">
...
<?php echo $__env->make("backend.layouts.master", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/httpdaff/tekstil-demo.yasingokhanerdogan.com/resources/views/backend/adminArea/products/add.blade.php ENDPATH**/ ?>