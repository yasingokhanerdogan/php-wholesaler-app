...
@section("title", "Soru Düzenle | $settings->title")
@section("content")
                ...
                <div class="col-md-6 col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ url("backend.admin.faq.update") }}" id="updateFaqsForm">
                                <div class="row">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" type="text"
                                               id="question"
                                               name="question"
                                                  placeholder="Soru">{{ $faq->question }}</textarea>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" type="text"
                                               id="answer"
                                               name="answer"
                                                  placeholder="Cevap">{!! $faq->answer !!}</textarea>
                                    </div>
                                </div>

                                <div class="mt-4">
                                    <button type="submit" id="updateFaq" class="btn btn-primary w-md">Kaydet
                                    </button>
                                </div>
                            </form>
                        </div>
