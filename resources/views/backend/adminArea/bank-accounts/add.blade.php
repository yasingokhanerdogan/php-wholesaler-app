                ...
                <div class="col-md-6 col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ url("backend.admin.bank.account.create") }}" id="createAccountForm">
                                <div class="row">
                                    <div class="mb-3">
                                ...
                                <div class="mt-4">
                                    <button type="submit" id="createAccount" class="btn btn-primary w-md">Kaydet</button>
                                </div>
                            </form>
                        </div>
                    </div>
