                        ...
                        <div class="card-body">
                            <div class="invoice-title">
                                ...
                                <div class="text-muted">
                                    ...
                                    <p class="mb-1"><i class="uil uil-envelope-alt me-1"></i> {{ $settings->address }}</p>
                                    ...
                                    <table class="table table-nowrap table-centered mb-0">
                                        ...
                                        @foreach($order->getOrderProducts as $item)
                                            <tr>
                                                ...
                                                <td class="text-end">{{ numberFormat($item->real_price * $item->amount) }}₺</td>
                                            </tr>
                                            @php $itemRank++; @endphp
                                        @endforeach
                                        ...
                                        <tr>
                                            <th scope="row" colspan="4" class="border-0 text-end">
                                                İndirim :</th>
                                            <td class="border-0 text-end">- {{ numberFormat($order->total_discount) }}₺</td>
                                        </tr>
                                        <tr>
                                            <th scope="row" colspan="4" class="border-0 text-end">
                                                Kargo :</th>
                                        ...
                                        <tr>
                                            ...
                                            <td class="border-0 text-end"><h4 class="m-0">{{ numberFormat($order->total_price) }}₺</h4></td>
                                        </tr>
                                        </tbody>
                                    </table>
                                </div>
