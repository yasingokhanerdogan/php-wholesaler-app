                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <div class="float-sm-end">
                                                        <ul class="pagination pagination-rounded mb-sm-0">
                                                            ...
                                                            @if ($pagination["page"] != 1)
                                                                <li class="page-item">
                                                                    <a href="{{ url("backend.client.search.results", ["slug" => $slug, "page" => "1"]) }}"
                                                            ...
                                                            @for ($i = $pagination["page"] - $pagination["forlimit"]; $i < $pagination["page"] + $pagination["forlimit"] + 1; $i++)
                                                                ...
                                                                @if ($i > 0 && $i <= $pagination["pageCount"])
                                                                    ...
                                                                    @else
                                                                        ...
                                                                        <li class="page-item">
                                                                            <a href="{{ url("backend.client.search.results", ["slug" => $slug, "page" => $i]) }}"
                                                                               class="page-link">{{ $i }}</a>
                                                                        </li>
                                                            ...
                                                            @if ($pagination["page"] != $pagination["pageCount"])
                                                                ...
                                                                <li class="page-item">
                                                                    <a href="{{ url("backend.client.search.results", ["slug" => $slug, "page" => $pagination["pageCount"]]) }}"
