...
@section("title", "Üye Girişi | $settings->company_name")
@section("content")
        ...
        <div class="container">
            ...
            <div class="row pb-100">
                <div class="col-md-6 offset-md-3">
                    <form method="POST" action="{{ url("frontend.signin") }}" class="form" id="loginForm">
                        ...
                        <div class="controls">
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-3 text-right">
                                    <a href="{{ url("frontend.changePassword.emailScreen") }}"> Şifremi Unuttum/Değiştir</a>
                                </div>
